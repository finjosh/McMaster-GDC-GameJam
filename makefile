...
SRCDIRS:=. src src/Utils/Graphics src/Utils/Physics src/Utils
# the include flags for compilation
INCLUDES:=-I /VSCodeFolder/Libraries/SFML-2.6.1/include -D SFML_STATIC -I /VSCodeFolder/Libraries/TGUI-1.1/include -I $(project_dir) -I /VSCodeFolder/Libraries/box2d-3.0/include -I $(project_dir)/include
# the paths to libs for linking
LIBS=-L /VSCodeFolder/Libraries/SFML-2.6.1/lib -L /VSCodeFolder/Libraries/TGUI-1.1/lib -L $(project_dir)/lib/Utils -L $(project_dir)/lib/Utils/Debug -L $(project_dir)/lib -L $(project_dir) -L /VSCodeFolder/Libraries/box2d-3.0/bin
